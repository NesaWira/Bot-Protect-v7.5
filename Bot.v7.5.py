...
cl = LINETCR.LINE()
cl.login(token="EoGvrDk5J8nMbtQa2IT4.Espwl7CcKKW9erpIgvmoTa.HnSNv436jP4WfG1C8XLeVif0p7rug0Q9rjJxAfPAPK8=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="EoTWKQ1cw5IVCtF5P7va.m05PgfJ20OHCnyQJ8clMQG.aG5DDWFxVNXGh34XfNACV1yNE/IurA8GOx2FpGjcVzw=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EopX799ITYB1ftwW3Ny3.eFqKRkdx3UCPENti1CVbCW.CP2T2Lg2Fn9Z5iTvW1l5gm4WqPMcK627VWgnSkUDeOM=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EomiF2CHGS2tUm7vlylf.CiOESA9RpOVz1/qwAI8chW.J5TNJtRkxUKEHTVsnPaXkCQdpALJo9K7P5vP9Z/CAfU= ")
ki.loginResult()
...
kc = LINETCR.LINE()
kc.login(token="EouIo0xdgSOnaLvGZcbd.y0pQ41mjRN+ZWUPdgIQxRq.2HV2qwGRPt89XrAdIcUtpXEMR4vQdyyhChP0RCjZkR0=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="EoWxmDsOXUzAi1sgx8Cc.bXcKkNxGPhATAhy524WgNa.HW1DuUZdl152JiOULjseYobxtg76Y1GRUMc4LS+s6Dc=")
kl.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u0710a42a75e0a476ad687639db8c069c"]
...
#===========================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                kc.sendText(msg.to, "Semua Hadir Bouz")
